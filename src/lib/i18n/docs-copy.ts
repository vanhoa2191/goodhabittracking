...
const vi = [
  ...
  ['ket-noi', 'Kết nối thiết bị của bé', 'Mở mã QR trong trang quản lý của phụ huynh. Trên máy của bé, chọn Quét QR hoặc nhập mã thủ công. Sau khi ghép, thiết bị này vào thẳng giao diện trẻ khi mở lại; không hiện bảng phụ huynh hay trang giới thiệu. Chỉ làm mới mã khi nghi ngờ mã đã bị lộ.'],
...
const en = [
  ...
  ['connect', 'Connect a child device', 'Open the parent QR. On the child device, scan it or enter the code manually. Once paired, that device opens directly in the child view, without parent or sales navigation. Refresh the code only if it may have been exposed.'],
